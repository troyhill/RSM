...
pkgs <- c("plyr", "dplyr", "data.table", "quantreg", "timeSeries", "sig", "assertive", "stringr", 
          "sp", "RColorBrewer", "maptools", "rgdal", "maps", "shapefiles", "mapdata", "rgeos", "PBSmapping")
...
source( "../Extract/NetCDF4_nodeDistance.R" )  # modified form of code written by Joseph Park, Everglades National Park
source( "../Extract/DataExtract.R" )           # modified form of code written by Joseph Park, Everglades National Park
source( "../Extract/unitConversion.R" )        # written by Gregg Reynolds, Everglades National Park
...
dssPath <- normalizePath('../DSSvue_python/')
outPath <- normalizePath('../../temp/')
